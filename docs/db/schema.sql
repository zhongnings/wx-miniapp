...
CREATE TABLE IF NOT EXISTS t_order_loan_info (
    ...
    assignee_org VARCHAR(128),
    channel_org VARCHAR(128),
    pay_method VARCHAR(32),
    product_type VARCHAR(64),
    borrower_category VARCHAR(16),
    contract_sign_mode VARCHAR(32),
    loan_amount DECIMAL(18,2),
    loan_amount_uppercase VARCHAR(64),
    loan_days INT,
    start_date DATE,
    end_date DATE,
    annual_rate DECIMAL(5,2),
    sign_place VARCHAR(128),
    usage_desc VARCHAR(128),
    repay_mode VARCHAR(64),
    dispute_way VARCHAR(64),
    arbitration_org VARCHAR(128),
    is_notarization VARCHAR(8),
...
CREATE TABLE IF NOT EXISTS t_order_contract (
    ...
    qr_code_url VARCHAR(255) COMMENT '签署二维码URL',
